    ...
    _analogOutput(new AnalogOutput)
{
    ...
    _analogOutput->nChannels = 3;
	_analogOutput->nAlines = 1000;
		//nAlines;
    _analogOutput->nFrames1 = 3072;
    _analogOutput->ScanPatternFile1 = "500fixy1Vscan.bin";
	//_analogOutput->ScanPatternFile1 = "2sp20160115prev.bin";
    _analogOutput->nFrames2 = 4800;
    _analogOutput->ScanPatternFile2 = "Pattern4.bin";
    ...
    memoryManager->FrameCountToAllocate = 12000;
